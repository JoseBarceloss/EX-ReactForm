...
describe('3 - Crie um terceiro `<fieldset>` para dados do último emprego', () => {
  ...
  /* Resumo do currículo */
  it('Será verificado se existe uma caixa de texto associado a uma `label` com o texto `Resumo do currículo`', () => {
  ...
  /* Cargo */
  it('Será verificado se existe um campo do tipo `text` associado a uma `label` com o texto `Cargo`', () => {
  ...
  /* Descrição do cargo */
  it('Será verificado se existe uma caixa de texto associado a uma `label` com o texto `Descrição do cargo`', () => {
